...
Todo: Add Async Methods C++ REST SDK may be the best option, but will require C++11 support, but POCO has Tasks (equivalent?)
Todo: Unit Tests!
Todo: Add post build task in shared libs to copy dlls to the exe sample program path
/////////////////////////////////////////////////////////////////////////////
